...
function submit_comment(){
	...
	$('#release_com').click(function(){
		...
		getopage(1,com_id);
		//str_div = '<ul class="media1-list"><li class="media1"> <a href="javascript:void(0);" class="pull-left"><img src="'+picurl+'" class="media1-object"></a><div class="media1-body"><h4 class="media1-heading"><a class="com_toggle" href="javascript:;">回复</a><span class="user-name">'+cur_name+'</span>'+teacher+'<span class="time">刚刚</span><span class="child_uid">'+uid+'</span></h4><p>'+comment+'</p><div class="media1 child_comment" style="display: none;"><a class="pull-left" href="javascript:void(0);"><img class="media1-object" src="'+picurl+'"></a><div class="media1-body"><h4 class="media1-heading"><span class="user-name">'+cur_name+'</span></h4><div class="comment-input"><textarea class="form-control" rows="3" placeholder="我要评论"></textarea><div class="btnbox"><button type="button" class="btn btn-micv5 btn-lg-fts reply com_'+com_id+'">回复</button></div></div></div></div></div></li></ul>';
        if(comment!=""){
	...
	$('.reply').live("click",function(){
		...
		str_div = '<div class="media1"><a href="javascript:void(0);" class="pull-left"><img src="'+picurl+'" class="media1-object"></a><div class="media1-body"><h4 class="media1-heading"><a class="com_child_toggle" href="javascript:;">回复</a><span class="user-name">'+cur_name+'</span>'+teacher+'<span class="time">刚刚</span><span class="child_uid">'+child_uid+'</span></h4><div class="zy_shou"><p class="t5o">'+html_encode(comment)+'</p><p>查看更多</p></div></div></div>';
		str_div=$(str_div);
		if(comment!=""){
